...
@Component({
  selector: 'app-files-uploaded-tds',
  templateUrl: './files-uploaded-tds.component.html',
  styleUrls: ['./files-uploaded-tds.component.css']
})
export class FilesUploadedTdsComponent implements OnInit{
