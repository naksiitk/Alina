...
exports.onboard_mail = async (req) => {
  var mailOptions = {
      from: 'noreply@silversoft.business',
      to: req.to,
...
exports.ask_mail = async (req,res) => {
  ...
  var mailOptions = {
      from: 'noreply@silversoft.business',
      to: req.email,
      subject: 'Files Asked from Arasuaudit -' + req.filename,
      html: `
              <head>
      <title></title>
      <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
...
exports.new_signup_mail = async (req,res) => {
  console.log(req)
  
  var mailOptions = {
      from: 'noreply@silversoft.business',
      to: 'arasuaudit@gmail.com',
      subject: 'From Alina - ' + req.user_name + ' Account Created',
      html: `
              <head>
      <title></title>
      <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
      ...
      <td class="pad" style="padding-top:70px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
      <div style="color:#000000;font-size:14px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:16.8px;">
      <p style="margin: 0; margin-bottom: 16px;">Dear Sir,</p>
      <p style="margin: 0;"><br/>Folling account is created: <br/>
      <br/>
      <br/>
...
exports.files_uploaded_mail = async (req,res) => {
  console.log(req)
  
  var mailOptions = {
      from: 'noreply@silversoft.business',
      to: 'arasuaudit@gmail.com',
      subject: 'Alina files uploaded ' + req.name,
      html: `
              <head>
      <title></title>
      <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
      ...
      <div style="color:#000000;font-size:14px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:16.8px;">
      <p style="margin: 0; margin-bottom: 16px;">Dear Sir,</p>
      <p style="margin: 0;"><br/>The following files were uploaded: <br/><br/>
  ...
  Files_uploaded :    ${req.files_uploads}      
      </pre>

      This mail is from Alina.
      </p>
      </div>
      </td>
      </tr>
